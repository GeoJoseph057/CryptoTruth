...
import {
  ...
  yt,
  zt
} from "./chunk-FPSDSDIC.js";
import "./chunk-GGGUWXEF.js";
import {
  __commonJS,
  __esm,
  __export,
...
function __generator(thisArg, body) {
  ...
  function step(op) {
    ...
    while (_5)
      try {
        if (f5 = 1, y7 && (t = op[0] & 2 ? y7["return"] : op[0] ? y7["throw"] || ((t = y7["return"]) && t.call(y7), 0) : y7.next) && !(t = t.call(y7, op[1])).done)
          return t;
        if (y7 = 0, t)
          op = [op[0] & 2, t.value];
        switch (op[0]) {
...
var Jn2 = class extends An {
  ...
  process(e, n3) {
    ...
    for (let d3 = 16; d3 < 80; d3++) {
      const m2 = P[d3 - 15] | 0, F3 = Q[d3 - 15] | 0, q2 = x3.rotrSH(m2, F3, 1) ^ x3.rotrSH(m2, F3, 8) ^ x3.shrSH(m2, F3, 7), z4 = x3.rotrSL(m2, F3, 1) ^ x3.rotrSL(m2, F3, 8) ^ x3.shrSL(m2, F3, 7), I2 = P[d3 - 2] | 0, O6 = Q[d3 - 2] | 0, ot3 = x3.rotrSH(I2, O6, 19) ^ x3.rotrBH(I2, O6, 61) ^ x3.shrSH(I2, O6, 6), tt2 = x3.rotrSL(I2, O6, 19) ^ x3.rotrBL(I2, O6, 61) ^ x3.shrSL(I2, O6, 6), st2 = x3.add4L(z4, tt2, Q[d3 - 7], Q[d3 - 16]), at3 = x3.add4H(st2, q2, ot3, P[d3 - 7], P[d3 - 16]);
    ...
    for (let d3 = 0; d3 < 80; d3++) {
      const m2 = x3.rotrSH(l3, p5, 14) ^ x3.rotrSH(l3, p5, 18) ^ x3.rotrBH(l3, p5, 41), F3 = x3.rotrSL(l3, p5, 14) ^ x3.rotrSL(l3, p5, 18) ^ x3.rotrBL(l3, p5, 41), q2 = l3 & w6 ^ ~l3 & g6, z4 = p5 & h6 ^ ~p5 & S5, I2 = x3.add5L(L3, F3, z4, Yn[d3], Q[d3]), O6 = x3.add5H(I2, v5, m2, q2, Vn2[d3], P[d3]), ot3 = I2 | 0, tt2 = x3.rotrSH(r2, o, 28) ^ x3.rotrBH(r2, o, 34) ^ x3.rotrBH(r2, o, 39), st2 = x3.rotrSL(r2, o, 28) ^ x3.rotrBL(r2, o, 34) ^ x3.rotrBL(r2, o, 39), at3 = r2 & s2 ^ r2 & u4 ^ s2 & u4, Ct3 = o & a3 ^ o & i3 ^ a3 & i3;
      v5 = g6 | 0, L3 = S5 | 0, g6 = w6 | 0, S5 = h6 | 0, w6 = l3 | 0, h6 = p5 | 0, { h: l3, l: p5 } = x3.add(D5 | 0, c4 | 0, O6 | 0, ot3 | 0), D5 = u4 | 0, c4 = i3 | 0, u4 = s2 | 0, i3 = a3 | 0, s2 = r2 | 0, a3 = o | 0;
  ...
  return { constTimeNegate: zt2, hasPrecomputes(n3) {
    ...
    for (let l3 = 0; l3 < a3; l3++) {
      ...
      if (o === Se)
        break;
      let w6 = Number(o & i3);
      if (o >>= c4, w6 > u4 && (w6 -= D5, o += gt2), w6 === 0)
        continue;
...
function yr(t) {
  ...
  class d3 {
    ...
    static fromAffine(f5) {
      ...
      const { x: b6, y: E5 } = f5 || {};
      return g6("x", b6), g6("y", E5), new d3(b6, E5, j2, c4(b6 * E5));
    }
    static normalizeZ(f5) {
      const b6 = n3.invertBatch(f5.map((E5) => E5.ez));
      return f5.map((E5, B3) => E5.toAffine(b6[B3])).map(d3.fromAffine);
    }
    static msm(f5, b6) {
    ...
    multiplyUnsafe(f5, b6 = d3.ZERO) {
      const E5 = f5;
      return ft2("scalar", E5, G, r2), E5 === G ? F3 : this.is0() || E5 === j2 ? this : q2.wNAFCachedUnsafe(this, E5, d3.normalizeZ, b6);
    }
    isSmallOrder() {
    ...
    static fromHex(f5, b6 = false) {
      ...
      return et2 !== X3 && (Z2 = c4(-Z2)), d3.fromAffine({ x: Z2, y: _5 });
    }
  ...
  const { BASE: m2, ZERO: F3 } = d3, q2 = lr(d3, u4 * 8);
  function z4(y7) {
    return H(y7, r2);
  }
  function I2(y7) {
  ...
  function st2(y7, f5, b6 = {}) {
    ...
    const { prefix: E5, scalar: B3, pointBytes: C2 } = O6(f5), A2 = tt2(b6.context, E5, y7), U6 = m2.multiply(A2).toRawBytes(), _5 = tt2(b6.context, U6, C2, y7), T2 = z4(A2 + _5 * B3);
  ...
  function Ct3(y7, f5, b6, E5 = at3) {
    ...
    let _5, T2, $4;
    try {
      _5 = d3.fromHex(b6, C2), T2 = d3.fromHex(y7.slice(0, A2), C2), $4 = m2.multiplyUnsafe(U6);
    } catch {
      return false;
    }
  ...
  return m2._setWindowSize(8), { CURVE: e, getPublicKey: ot3, sign: st2, verify: Ct3, ExtendedPoint: d3, utils: { getExtendedPublicKey: O6, randomPrivateKey: () => a3(n3.BYTES), precompute(y7 = 8, f5 = d3.BASE) {
...
function Ir(t, e) {
  ...
  function l3(h6) {
    ...
    if (h6.length === 0)
      return "";
    for (var g6 = 0, S5 = 0, v5 = 0, L3 = h6.length; v5 !== L3 && h6[v5] === 0; )
      v5++, g6++;
    for (var d3 = (L3 - v5) * c4 + 1 >>> 0, m2 = new Uint8Array(d3); v5 !== L3; ) {
      for (var F3 = h6[v5], q2 = 0, z4 = d3 - 1; (F3 !== 0 || q2 < S5) && z4 !== -1; z4--, q2++)
        F3 += 256 * m2[z4] >>> 0, m2[z4] = F3 % u4 >>> 0, F3 = F3 / u4 >>> 0;
      if (F3 !== 0)
  ...
  function p5(h6) {
    ...
    if (h6[g6] !== " ") {
      for (var S5 = 0, v5 = 0; h6[g6] === i3; )
        S5++, g6++;
      for (var L3 = (h6.length - g6) * D5 + 1 >>> 0, d3 = new Uint8Array(L3); h6[g6]; ) {
        var m2 = n3[h6.charCodeAt(g6)];
        if (m2 === 255)
          return;
        for (var F3 = 0, q2 = L3 - 1; (m2 !== 0 || F3 < v5) && q2 !== -1; q2--, F3++)
          m2 += u4 * d3[q2] >>> 0, d3[q2] = m2 % 256 >>> 0, m2 = m2 / 256 >>> 0;
        if (m2 !== 0)
          throw new Error("Non-zero carry");
        v5 = F3, g6++;
      }
      if (h6[g6] !== " ") {
        for (var z4 = L3 - v5; z4 !== L3 && d3[z4] === 0; )
          z4++;
...
function Hi(r2, e) {
  ...
  function p5(u4) {
    ...
    if (u4.length === 0)
      return "";
    for (var m2 = 0, z4 = 0, I2 = 0, _5 = u4.length; I2 !== _5 && u4[I2] === 0; )
      I2++, m2++;
    for (var S5 = (_5 - I2) * d3 + 1 >>> 0, f5 = new Uint8Array(S5); I2 !== _5; ) {
      for (var T2 = u4[I2], A2 = 0, C2 = S5 - 1; (T2 !== 0 || A2 < z4) && C2 !== -1; C2--, A2++)
        T2 += 256 * f5[C2] >>> 0, f5[C2] = T2 % a3 >>> 0, T2 = T2 / a3 >>> 0;
      if (T2 !== 0)
        throw new Error("Non-zero carry");
      z4 = A2, I2++;
    }
    for (var x4 = S5 - z4; x4 !== S5 && f5[x4] === 0; )
      x4++;
    for (var q2 = h6.repeat(m2); x4 < S5; ++x4)
      q2 += r2.charAt(f5[x4]);
    return q2;
  }
  function y7(u4) {
    ...
    var m2 = 0;
    if (u4[m2] !== " ") {
      for (var z4 = 0, I2 = 0; u4[m2] === h6; )
        z4++, m2++;
      for (var _5 = (u4.length - m2) * l3 + 1 >>> 0, S5 = new Uint8Array(_5); u4[m2]; ) {
        var f5 = t[u4.charCodeAt(m2)];
        if (f5 === 255)
          return;
        for (var T2 = 0, A2 = _5 - 1; (f5 !== 0 || T2 < I2) && A2 !== -1; A2--, T2++)
          f5 += a3 * S5[A2] >>> 0, S5[A2] = f5 % 256 >>> 0, f5 = f5 / 256 >>> 0;
        if (f5 !== 0)
          throw new Error("Non-zero carry");
        I2 = T2, m2++;
      }
      if (u4[m2] !== " ") {
        for (var C2 = _5 - I2; C2 !== _5 && S5[C2] === 0; )
          C2++;
...
var vr2 = class extends u {
  constructor(e, t) {
    super(e, t), this.relayer = e, this.logger = t, this.events = new import_events5.EventEmitter(), this.name = at2, this.queue = /* @__PURE__ */ new Map(), this.publishTimeout = (0, import_time2.toMiliseconds)(import_time2.TEN_SECONDS), this.needsTransportRestart = false, this.publish = async (i3, s2, n3) => {
      ...
      try {
        const a3 = (n3 == null ? void 0 : n3.ttl) || ot2, h6 = vt(n3), l3 = (n3 == null ? void 0 : n3.prompt) || false, d3 = (n3 == null ? void 0 : n3.tag) || 0, p5 = (n3 == null ? void 0 : n3.id) || getBigIntRpcId().toString(), y7 = { topic: i3, message: s2, opts: { ttl: a3, relay: h6, prompt: l3, tag: d3, id: p5 } }, M4 = setTimeout(() => this.queue.set(p5, y7), this.publishTimeout);
        try {
          await await ut(this.rpcPublish(i3, s2, a3, h6, l3, d3, p5), this.publishTimeout, "Failed to publish payload, please try again."), this.removeRequestFromQueue(p5), this.relayer.events.emit(D3.publish, y7);
        } catch (u4) {
...
var g4 = (m2, r2) => {
  for (var e in r2 || (r2 = {}))
    ps2.call(r2, e) && de3(m2, e, r2[e]);
  if (he3)
    for (var e of he3(r2))
      hs2.call(r2, e) && de3(m2, e, r2[e]);
  return m2;
};
...
var ds2 = class extends w3 {
  constructor(r2) {
    super(r2), this.name = ce2, this.events = new import_events6.default(), this.initialized = false, this.ignoredPayloadTypes = [_], this.requestQueue = { state: I.idle, queue: [] }, this.sessionRequestQueue = { state: I.idle, queue: [] }, this.requestQueueDelay = import_time3.ONE_SECOND, this.init = async () => {
      ...
      const T2 = g4({ relay: { protocol: t ?? "irn" }, namespaces: i3, requiredNamespaces: p5, optionalNamespaces: d3, pairingTopic: a3, controller: { publicKey: h6, metadata: this.client.metadata }, expiry: pt(A) }, n3 && { sessionProperties: n3 });
      ...
      return n3 && (h6.ttl = n3), o && (h6.id = o), this.client.core.history.set(s2, p5), c4 ? (h6.internal = b4(g4({}, h6.internal), { throwOnFailedPublish: true }), await this.client.core.relayer.publish(s2, d3, h6)) : this.client.core.relayer.publish(s2, d3, h6).catch((R2) => this.client.logger.error(R2)), p5.id;
      ...
      n3 ? (p5.internal = b4(g4({}, p5.internal), { throwOnFailedPublish: true }), await this.client.core.relayer.publish(t, a3, p5)) : this.client.core.relayer.publish(t, a3, p5).catch((d3) => this.client.logger.error(d3)), await this.client.core.history.resolve(o);
      ...
      try {
        ...
        const { relay: n3, controller: o, expiry: a3, namespaces: c4, requiredNamespaces: p5, optionalNamespaces: d3, sessionProperties: h6, pairingTopic: R2 } = s2.params, w6 = g4({ topic: e, relay: n3, expiry: a3, namespaces: c4, acknowledged: true, pairingTopic: R2, requiredNamespaces: p5, optionalNamespaces: d3, controller: o.publicKey, self: { publicKey: "", metadata: this.client.metadata }, peer: { publicKey: o.publicKey, metadata: o.metadata } }, h6 && { sessionProperties: h6 });
  ...
  (function() {
    ...
    var Af = function h6(g6) {
      ...
      function Fs2(n3, t) {
        ...
        for (var v5 in n3)
          (t || F3.call(n3, v5)) && !(f5 && (v5 == "length" || s2 && (v5 == "offset" || v5 == "parent") || o && (v5 == "buffer" || v5 == "byteLength" || v5 == "byteOffset") || Zn2(v5, l3))) && c4.push(v5);
        return c4;
      }
      function Ms2(n3) {
        var t = n3.length;
      ...
      function An2(n3, t, e, r2, s2, o) {
        ...
        if (_5) {
          ...
          if (m2 == qn3 || m2 == Ot3 || w6 && !s2) {
            if (f5 = l3 || w6 ? {} : bu(n3), !c4)
              return l3 ? Zc(n3, vc(f5, n3)) : Yc(n3, qs2(f5, n3));
          } else {
            if (!q2[m2])
              return s2 ? n3 : {};
            f5 = sh(n3, m2, c4);
      ...
      function Ge3(n3, t, e) {
        for (var r2 = -1, s2 = n3.length; ++r2 < s2; ) {
          var o = n3[r2], f5 = t(o);
          if (f5 != null && (c4 === i3 ? f5 === f5 && !pn(f5) : e(f5, c4)))
            var c4 = f5, l3 = o;
        }
        return l3;
      }
      function wc(n3, t, e, r2) {
        var s2 = n3.length;
        for (e = b6(e), e < 0 && (e = -e > s2 ? 0 : s2 + e), r2 = r2 === i3 || r2 > s2 ? s2 : b6(r2), r2 < 0 && (r2 += s2), r2 = e > r2 ? 0 : aa(r2); e < r2; )
          n3[e++] = t;
        return n3;
      }
      function Ks2(n3, t) {
      ...
      function yc(n3, t, e, r2, s2, o) {
        ...
        if (w6 && !_5)
          return o || (o = new Rn2()), f5 || Bt4(n3) ? Su(n3, t, e, r2, s2, o) : jc(n3, t, l3, e, r2, s2, o);
        if (!(e & Et4)) {
      ...
      function kr2(n3, t, e, r2) {
        ...
        for (; ++s2 < o; ) {
          ...
          if (f5 && c4[2]) {
            ...
            var m2 = new Rn2();
            if (r2)
              var w6 = r2(v5, _5, l3, n3, t, m2);
            if (!(w6 === i3 ? oe3(_5, v5, Et4 | ve3, r2, m2) : w6))
              return false;
          }
        }
        return true;
      ...
      function ti(n3, t, e, r2) {
        ...
        for (n3 === t && (t = un(t)), e && (c4 = G5(n3, hn(e))); ++o < f5; )
      ...
      function Nc(n3, t, e, r2) {
        for (var s2 = -1, o = Q5(Ue3((t - n3) / (e || 1)), 0), f5 = p5(o); o--; )
          f5[r2 ? o : ++s2] = n3, n3 += e;
        return f5;
      }
      function ri(n3, t) {
      ...
      function ii(n3, t, e, r2) {
        ...
        for (var f5 = t !== t, c4 = t === null, l3 = pn(t), v5 = t === i3; s2 < o; ) {
          ...
          if (f5)
            ...
            v5 ? y7 = E5 && (r2 || w6) : c4 ? y7 = E5 && w6 && (r2 || !I2) : l3 ? y7 = E5 && w6 && !I2 && (r2 || !T2) : I2 || T2 ? y7 = false : y7 = r2 ? m2 <= t : m2 < t;
          y7 ? s2 = _5 + 1 : o = _5;
        }
        return nn(o, Fa);
      }
      ...
      function ui(n3, t, e) {
        ...
        for (var s2 = -1, o = p5(r2); ++s2 < r2; )
          for (var f5 = n3[s2], c4 = -1; ++c4 < r2; )
            c4 != s2 && (o[s2] = ue3(o[s2] || f5, n3[c4], t, e));
      ...
      function pu(n3, t) {
        if (n3 !== t) {
          ...
          if (!c4 && !v5 && !o && n3 > t || o && f5 && l3 && !c4 && !v5 || r2 && f5 && l3 || !e && l3 || !s2)
            return 1;
          if (!r2 && !o && !v5 && n3 < t || v5 && e && s2 && !r2 && !o || c4 && e && s2 || !f5 && s2 || !l3)
            return -1;
        }
        return 0;
      }
      ...
      function du(n3, t, e, r2) {
        for (var s2 = -1, o = n3.length, f5 = e.length, c4 = -1, l3 = t.length, v5 = Q5(o - f5, 0), _5 = p5(l3 + v5), m2 = !r2; ++c4 < l3; )
          _5[c4] = t[c4];
        for (; ++s2 < f5; )
      ...
      function gu(n3, t, e, r2) {
        for (var s2 = -1, o = n3.length, f5 = -1, c4 = e.length, l3 = -1, v5 = t.length, _5 = Q5(o - c4, 0), m2 = p5(_5 + v5), w6 = !r2; ++s2 < _5; )
          m2[s2] = n3[s2];
        for (var I2 = s2; ++l3 < v5; )
          m2[I2 + l3] = t[l3];
        for (; ++f5 < c4; )
          (w6 || s2 < o) && (m2[I2 + e[f5]] = n3[s2++]);
        return m2;
      }
      function un(n3, t) {
      ...
      function Xc(n3, t, e) {
        var r2 = ce3(n3);
        function s2() {
          for (var o = arguments.length, f5 = p5(o), c4 = o, l3 = qt4(s2); c4--; )
            f5[c4] = arguments[c4];
          var v5 = o < 3 && f5[0] !== l3 && f5[o - 1] !== l3 ? [] : tt2(f5, l3);
          if (o -= v5.length, o < e)
            return Iu(n3, t, Xe4, s2.placeholder, i3, f5, v5, i3, i3, e - o);
      ...
      function Pu(n3) {
        return Yn2(function(t) {
          ...
          return function() {
            ...
            if (f5 && v5.length == 1 && R2(_5))
              return f5.plant(_5).value();
            for (var m2 = 0, w6 = e ? t[m2].apply(this, v5) : _5; ++m2 < e; )
              w6 = t[m2].call(this, w6);
            return w6;
          };
        });
      }
      function Xe4(n3, t, e, r2, s2, o, f5, c4, l3, v5) {
        ...
        function y7() {
          for (var D5 = arguments.length, N6 = p5(D5), dn2 = D5; dn2--; )
      ...
      function Qc(n3, t, e, r2) {
        ...
        function f5() {
          for (var c4 = -1, l3 = arguments.length, v5 = -1, _5 = r2.length, m2 = p5(_5 + l3), w6 = this && this !== k5 && this instanceof f5 ? o : n3; ++v5 < _5; )
            m2[v5] = r2[v5];
          for (; l3--; )
            m2[v5++] = arguments[++c4];
      ...
      function Kn3(n3, t, e, r2, s2, o, f5, c4) {
        ...
        if (w6 && lh(I2, w6), n3 = I2[0], t = I2[1], e = I2[2], r2 = I2[3], s2 = I2[4], c4 = I2[9] = I2[9] === i3 ? l3 ? 0 : n3.length : Q5(I2[9] - v5, 0), !c4 && t & (Dn | yt4) && (t &= ~(Dn | yt4)), !t || t == vn2)
          var E5 = Jc(n3, t, e);
        else
          t == Dn || t == yt4 ? E5 = Xc(n3, t, c4) : (t == Hn3 || t == (vn2 | Hn3)) && !s2.length ? E5 = Qc(n3, t, e, r2) : E5 = Xe4.apply(i3, I2);
        var T2 = w6 ? iu : Nu;
      ...
      function Su(n3, t, e, r2, s2, o) {
        ...
        for (o.set(n3, t), o.set(t, n3); ++m2 < c4; ) {
          ...
          if (r2)
            var y7 = f5 ? r2(T2, E5, m2, t, n3, o) : r2(E5, T2, m2, n3, t, o);
          if (y7 !== i3) {
            if (y7)
              continue;
            w6 = false;
      ...
      function nh(n3, t, e, r2, s2, o) {
        ...
        for (var y7 = f5; ++m2 < l3; ) {
          ...
          if (r2)
            var dn2 = f5 ? r2(N6, D5, w6, t, n3, o) : r2(D5, N6, w6, n3, t, o);
...
`);
      ...
      function Du(n3, t, e) {
        return t = Q5(t === i3 ? n3.length - 1 : t, 0), function() {
          for (var r2 = arguments, s2 = -1, o = Q5(r2.length - t, 0), f5 = p5(o); ++s2 < o; )
            f5[s2] = r2[t + s2];
          s2 = -1;
      ...
      function _h(n3, t, e) {
        ...
        if (!r2 || t < 1)
          return [];
        for (var s2 = 0, o = 0, f5 = p5(Ue3(r2 / t)); s2 < r2; )
          f5[o++] = Cn2(n3, s2, s2 += t);
        return f5;
      }
      function mh(n3) {
      ...
      function Pp(n3) {
        if (n3 == null)
          return true;
        if (an(n3) && (R2(n3) || typeof n3 == "string" || typeof n3.splice == "function" || at3(n3) || Bt4(n3) || Pt3(n3)))
          return !n3.length;
        var t = tn(n3);
        if (t == yn2 || t == Sn2)
          return !n3.size;
      ...
      var qp = L3(function(n3, t) {
        ...
        for (s2 && rn2(t[0], t[1], s2) && (r2 = 1); ++e < r2; )
          for (var o = t[e], f5 = on2(o), c4 = -1, l3 = f5.length; ++c4 < l3; ) {
...
function L2(a3) {
  ...
  const o = { chains: t, methods: i3 || u3, events: e || m, rpcMap: p4({}, t.length ? { [g5(t)]: c4[g5(t)] } : {}) }, r2 = e == null ? void 0 : e.filter((l3) => !m.includes(l3)), d3 = i3 == null ? void 0 : i3.filter((l3) => !u3.includes(l3));
  if (!s2 && !h6 && !n3 && !(r2 != null && r2.length) && !(d3 != null && d3.length))
    return { required: t.length ? o : void 0 };
  const C2 = (r2 == null ? void 0 : r2.length) && (d3 == null ? void 0 : d3.length) || !s2, I2 = { chains: [...new Set(C2 ? o.chains.concat(s2 || []) : s2)], methods: [...new Set(o.methods.concat(n3 != null && n3.length ? n3 : E4))], events: [...new Set(o.events.concat(h6 != null && h6.length ? h6 : _4))], rpcMap: c4 };
...
var v4 = class _v {
  ...
  getRpcConfig(t) {
    ...
    const c4 = n3.length ? (t == null ? void 0 : t.methods) || u3 : [], o = n3.length ? (t == null ? void 0 : t.events) || m : [], r2 = (t == null ? void 0 : t.optionalMethods) || [], d3 = (t == null ? void 0 : t.optionalEvents) || [], C2 = (t == null ? void 0 : t.rpcMap) || this.buildRpcMap(h6, t.projectId), I2 = (t == null ? void 0 : t.qrModalOptions) || void 0;
    return { chains: n3 == null ? void 0 : n3.map((l3) => this.formatChainId(l3)), optionalChains: e.map((l3) => this.formatChainId(l3)), methods: c4, events: o, optionalMethods: r2, optionalEvents: d3, rpcMap: C2, showQrModal: !!(t != null && t.showQrModal), qrModalOptions: I2, projectId: t.projectId, metadata: t.metadata };
  }
  buildRpcMap(t, s2) {
    const i3 = {};
    return t.forEach((n3) => {
  ...
  async initialize(t) {
    if (this.rpc = this.getRpcConfig(t), this.chainId = this.rpc.chains.length ? g5(this.rpc.chains) : g5(this.rpc.optionalChains), this.signer = await hv.init({ projectId: this.rpc.projectId, metadata: this.rpc.metadata, disableProviderPing: t.disableProviderPing, relayUrl: t.relayUrl, storageOptions: t.storageOptions }), this.registerEventListeners(), await this.loadPersistedSession(), this.rpc.showQrModal) {
      let s2;
      try {
        const { WalletConnectModal: i3 } = await import("./dist-VRF2ZSRE.js");
        s2 = i3;
      } catch {
...
@walletconnect/universal-provider/dist/index.es.js:
  ...
  *)
*/
//# sourceMappingURL=index.es-NK5VZ6VQ.js.map
